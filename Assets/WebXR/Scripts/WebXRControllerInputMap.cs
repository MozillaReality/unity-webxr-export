...
namespace WebXR
{
    ...
    {
        [Header("WebXR Controller Input Map")] public List<WebXRControllerInput> inputs;
    }
    ...
    public class WebXRControllerInput
    {
        ...
        [Header("Web Gamepad API configuration")] [Tooltip("Button or axes ID from Web Gamepad API.")]
        ...
        [Header("Unity Input Manager configuration")] [Tooltip("Input name defined in Unity Input Manager.")]
